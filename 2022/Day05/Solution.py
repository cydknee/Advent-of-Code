...
def remove_text_from_move_list(moves):
    return [[int(y.replace("move", "").replace(" ", "")) for x in z.split("to") for y in x.split("from")] for z in
            moves.splitlines()]
...
if __name__ == '__main__':
    print(part1_and_part2(False))  # GFTNRBZPF
    print(part1_and_part2(True))  # VRQWPDSGP
